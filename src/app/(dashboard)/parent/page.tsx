...
const ParentPage = async ({
  ...
  const validScores = selectedChild.results
    .map((r) => r.score)
            ...
            {children.map((child) => {
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 rounded-xl border p-2.5 transition-all duration-150 sm:px-4 sm:py-3 ${
                    isSelected
                ...
                >
                  ...
                  <div>
                    <p className="text-xs font-bold leading-tight text-gray-900 sm:text-sm">
            ...
            {childTeachers.map((teacher: any) => (
              ...
              >
                ...
                <div className="flex shrink-0 items-center gap-1.5">
                  <Link
                    href={`/list/messages`}
                    className="rounded-lg border border-gray-200 bg-white px-2.5 py-1 text-[11px] font-semibold text-gray-700 shadow-sm transition hover:bg-gray-100"
                  >
                    Message
                  </Link>
                </div>
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm sm:p-5">
          ...
          {selectedChild.results.length === 0 ? (
            <p className="py-4 text-center text-xs text-gray-400">
              No recent exam scores recorded yet.
            </p>
          ) : (
